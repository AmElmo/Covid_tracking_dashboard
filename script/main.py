...
def cron_job(request):
    ...
    print("Fetching cases and deaths data from WHO")
    ...
    print("Fetching vaccination data from WHO")
    ...
    # Death & Cases data
    print("Turning the CSV files into dataframes")
    ...
    print("💽 Starting data manipulation scripts on cases and deaths data")
    ...
    print("💽 Starting data manipulation scripts on vaccination data")
